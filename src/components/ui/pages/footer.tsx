                ...
                >
                            ...
                            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                                <div className="w-full mb-10">
                                    ...
                                    <p className="text-base text-body-color dark:text-dark-6 mb-7">
                                        A book library is a web or mobile application that serves as a platform for users to explore, discover, and engage with books and related content.
                                    </p>
                                    <p
                    ...
                    <div className='text-center'>
                        <p className="text-base text-body-color dark:text-dark-6">
                            &copy; 2024 Book Library Developed by <span className=' font-semibold text-orange-600 cursor-pointer  text-center'>Mostafiz</span>
                        </p>
                    </div>
                </footer>
            </div>
